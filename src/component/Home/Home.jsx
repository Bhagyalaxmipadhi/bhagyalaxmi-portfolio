...
import Profile_img from "../../assets/portfollio.png";
import AnchorLink from "react-anchor-link-smooth-scroll";

function Home() {
  const [typedText, setTypedText] = useState("");
  const textToType = "I'm Bhagyalaxmi Padhi,";
  ...
  const handleDownload = () => {
    const fileId = "1x2PmJ3jDvRs8Q2cEIRM75kZEZqChHqtJ";
    const url = `https://drive.google.com/uc?export=download&id=${fileId}`;

    const anchor = document.createElement("a");
    anchor.href = url;
    anchor.download = "Bhagyalaxmi_Padhi_Frontend_Developer.pdf";
  ...
  return (
    ...
    >
      ...
      <p className="mb-4 md:mb-6 text-lg md:text-2xl text-center leading-8 md:leading-10">
        I am a Frontend Developer from Hyderabad, India. I am a MCA Graduate
        2023.
      </p>
